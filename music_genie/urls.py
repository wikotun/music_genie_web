...
from music_app.views import LandingPageView,ArtistCreateView,ArtistListView,ArtistUpdateView,deleteArtist,SongCreateView,SongListView,SongUpdateView,deleteSong
